...
sqliteLibraryPort db =
  LibraryPort
    ...
    , deleteIgnoredArticles = deleteIgnoredSqlite db
    , deleteOlderArticles = deleteOlderThanSqlite db
    , replaceKnownWords = saveKnownWordsSqlite db
    , addKnownWords = addKnownWordsSqlite db
    , clearKnownWords = clearKnownWordsSqlite db
    , clearKnownPercentages = clearAllKnownPctSqlite db
